	...
	<body>
 	...
 	<li><a href="/merchant.php/Merchant/Index/index"><i class="icon icon-home"></i> <span>商家操作控制台</span></a></li>
				...
				<li class="submenu active open">
					...
					<ul>
						<li class="active"><a href="/merchant.php/Merchant/infoSettings/basicInformation">基本信息</a></li>
					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form class="form-horizontal" method="post" action="/merchant.php/Merchant/InfoSettings/modifyInfo" name="basic_validate" id="basic_validate" novalidate="novalidate" />
                                    <div class="control-group">
                                        <label class="control-label">店铺名称:</label>
                                        <div class="controls">
                                            <input type="text" name="shopname" id="required" value=<?php echo ($data[0]['shopname']); ?>>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">经营品牌:</label>
                                        <div class="controls">
                                            <input type="text" name="brand" id="email" value=<?php echo ($data[0]['brand']); ?> >
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">负责人姓名:</label>
                                        <div class="controls">
                                            <input type="text" name="truename" id="date" value=<?php echo ($data[0]['truename']); ?>>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">选择地区:</label>
                                        <div class="controls">
                                            <input type="text" name="address" id="url" value=<?php echo ($data[0]['address']); ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="phone" id="url" value=<?php echo ($data[0]['phone']); ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="email" id="url" value=<?php echo ($data[0]['email']); ?>>
                                        </div>
                                    </div>
                                     <div class="control-group">
                                        <label class="control-label">注册时间:</label>
                                        <div class="controls">
                                            <span><?php echo (date("Y-m-d H:i:s",$data[0]['lasttime'])); ?></span>

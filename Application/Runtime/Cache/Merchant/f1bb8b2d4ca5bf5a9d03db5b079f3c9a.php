...
<html lang="en">
	...
	<li class="submenu active open">
		...
		<ul>
			<li><a href="/merchant.php/Merchant/Orders/effectiveOrder">待解决订单</a></li>
...
<tr align="center">
	<td><br>
		<b>商品名称:</b><span style="color:red"> <?php echo ($result[0]['name']); ?></span><br/>
		<br>
		<img src="<?php echo ($result[0]['img']); ?>" width="400px">
	</td>
	
</tr>
<tr align="center">
	<td>
		单价:<span style="color:red;font-size:20px"><?php echo ($result[0]['price']/$result[0]['num']); ?></span>　　　　　数量：<span style="color:red;font-size:20px"><?php echo ($result[0]['num']); ?></span>　　　　　小计：<span style="color:red;font-size:20px"><?php echo ($res[0]['total']); ?></span>
	</td>
</tr>
	
</table>
<h4 align="center">用户相关信息</h4>
<table class="table table-hover table-striped">
	...
	<tr align="center">
		...
		<td><?php echo ($resu[0]['buyuser']); ?></td>
		<td><?php echo ($res[0]['linkname']); ?></td>
		<td><?php echo ($res[0]['address']); ?></td>
		<td><?php echo ($res[0]['phone']); ?></td>
		<td><?php echo (date("Y-m-d H:i:s",$res[0]['addtime'])); ?></td>
	</tr>
	<tr align="center">
	<td colspan="5"><a href="effectiveOrder" class="btn btn-primary btn-lg">回到订单列表</a></td>
	</tr>
</table>

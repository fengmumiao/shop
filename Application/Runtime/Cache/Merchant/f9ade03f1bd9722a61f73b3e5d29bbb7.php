...
<html lang="en">
    ...
    <li class="submenu active open">
        ...
        <ul>
            ...
            <!-- <li><a href="/merchant.php/Merchant/Orders/wasteOrder">订单查询</a></li> -->
...
<br/>
               <p align="center"><span style="color:orange;font-size:20px">订单收入状况</span>　　　　　　　从<input type="text" id="start" placeholder="格式 20140809"> 到 <input type="text" id="end" placeholder="结束日期"> 订单收入为 <b name="money" style="color:red;font-size:18px">0</b> 元</p>
    ...
    <form action="/merchant.php/Merchant/Orders/searchorders" method="post">
        ...
        <button type="submit" class="btn btn-info btn-sm">订单查询</button>
    </form>

<div class="table-responsive">
  <table class="table table-hover" style="color:#666;font-size:14px;">
    <tr class="one">
        <th>#</th>
        <th>用户名</th>
        <th>订单编号</th>
    ...
    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr align="center" class="content">
            ...
            <?php switch($vo["status"]): case "0": $state="<span style='color:red' class='sendGoods'>发货</span>"; break;?> 
                <?php case "1": $state="<span style='color:purple'>已发货</span>"; break;?>    
                <?php case "2": $state="<span style='color:green'>交易完成</span>"; break;?>    
                <?php case "3": $state="<span style='color:#333'>退货</span>"; break; endswitch;?>
...
<script type="text/javascript" src="/Public/Merchant/js/orders.js"></script>

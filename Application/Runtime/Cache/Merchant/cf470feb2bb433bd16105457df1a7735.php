	...
	<body>
 	...
 	<li><a href="/merchant.php/Merchant/Index/index"><i class="icon icon-home"></i> <span>商家操作控制台</span></a></li>
				...
				<li class="submenu active open">
					...
					<ul>
						<li class="active"><a href="/merchant.php/Merchant/Accessory/notMessage">回复留言</a></li>
...
<table class="table table-bordered table-hover">
		...
		<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
				...
				<td>
				<?php switch($vo["size"]): case "0": ?><span style='color:blue'>尺寸偏大</span><?php break;?> 
                    <?php case "1": ?><php><span style='color:red'>尺寸偏小</span><?php break; endswitch;?>
				</td>
				<td><?php echo (mb_substr($vo["review"],0,6,'utf-8')); ?></td>
				<td><?php echo (date("Y-m-d H:i:s",$vo["addtime"])); ?></td>
				<td><a href="/merchant.php/Merchant/Accessory/review?id=<?php echo ($vo["id"]); ?>" class="btn btn-primary">回复</td>

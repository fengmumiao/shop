...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <script type="text/javascript" src="/Public/Home/js/orderSet.js"></script>
...
<form action="/my/order.jhtml" name="searchForm" id="searchForm" method="post">
<div class="uc_orderfilter" style="margin-left:-180px;">
<h2 class="uc_odrfiltertit">我的订单</h2>
<div class="uc_orderselect">
    <p class="uc_fll"></p>
    <div class="uc_selectsty uc_select_6m">
        <input disabled="disabled" class="uc_selchecked" value="&nbsp;6个月以内订单" id="orderCreateTime" type="text">
  ...
  <!--   <div class="uc_selectsty uc_select_stat">
    ...
    <div class="uc_ordersearch" style="margin-left:-180px;">
        <input id="searchCriteria"  name="searchCriteria" value="订单号" type="text">
    </div>
</div>
</div>
<input value="14165401902671132" name="t" type="hidden">
</form>

<!--我最近的订单 start-->
<div class="zjorder" style="margin-left:-180px;">
    <form name="buyFormObj0" id="buyFormObj0" method="post" target="_blank">
        <input name="orderNo" id="orderNo0" value="A641118030014" type="hidden">
        <input name="orderRouteWay" value="user" type="hidden">
    </form>
    <!--主订单1 start-->
    <div class="seek">
   <?php if(is_array($orderParent)): foreach($orderParent as $key=>$orders): ?><table class="zjorderbody2" style="border:1px solid #E3E3E3;" width="200" cellpadding="0" cellspacing="1">
        <colgroup>
            <col width="571">
            <col width="106">
            <col width="153">
        ...
        <thead style="border:1px solid #E3E3E3;">
            <tr>
                <th colspan="3" style="border:1px solid #E3E3E3;">
                    <span>主订单号：<?php echo ($orders["ordernumber"]); ?></span>
                    <span>下单时间：<?php echo ($orders["addtime"]); ?></span>
                    <span>支付方式：
                        <?php if($orders["buytype"] == 0): ?>在线支付<?php endif; ?>
                    <!-- <font class="Gray">(未支付)</font></span> -->
                </th>
            </tr>
        </thead>
<tbody style="border:1px solid #E3E3E3;">
<?php if(is_array($orders["orr"])): foreach($orders["orr"] as $key=>$or): ?><tr style="border:1px solid #E3E3E3;">
<td style="border:1px solid #E3E3E3;">
<!--子订单1 start-->
<div class="uc_goods_item uc_myorder_item relative clearfix">
<p class="uc_goods_top">
<span>子订单号：<?php echo ($or["ordernumber"]); ?></span>
<span>商品数量：<?php echo ($or["num"]); ?>件</span>
<span>状态：<strong class="f_yellow">
<?php if($or["status"] == 0): ?>等待发货<?php endif; ?>
<?php if($or["status"] == 1): ?><a class="take" style="width:100px;border:1px solid #ccc;height:50px;line-height:50px;">确认收货</a>
<input class="num" type="hidden" value="<?php echo ($or["ordernumber"]); ?>"/><?php endif; ?>
<?php if($or["status"] == 2): ?>已收货<?php endif; ?>
<?php if($or["status"] == 3): ?>已退货<?php endif; ?>
</strong>
...
<a href="/Info/index/id/<?php echo ($or["goodsid"]); ?>" target="_blank">
<img src="<?php echo ($or["img"]); ?>" alt="<?php echo ($or["name"]); ?>" title="<?php echo ($or["name"]); ?>" height="60" width="60">
</a>
</dt>
<dd class="info2">
<p><a href="/Info/index/id/<?php echo ($or["goodsid"]); ?>" target="_blank" class="f_blue"><?php echo ($or["name"]); ?></a>
</p>
<p><em class="Gray">收货地址：</em><?php echo ($or["address"]); ?></p>
<p>     

</p> 
</dd>
<dd class="info3">
<p><strong>¥</strong><?php echo ($or["price"]); ?>
</p>
<p class="act_tips"><span><i></i></span>限时抢</p>

</dd>
<dd class="info4"><?php echo ($or["num"]); ?>件</dd>
...
<td>
<div class="goodsmn">
<p class="mncount"><?php echo ($or["price"]); ?>元</p>
<!-- <p class="hui">已优惠510元</p> -->
<p class="hui">
(免运费)
</p>
</div>
...
<a href="/index.php/Lists" onclick="">继续购买</a>
</p>
</div>
</td>

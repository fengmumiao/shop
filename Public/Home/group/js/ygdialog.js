...
ygDialog.fn = ygDialog.prototype = {
	...
	loading:function(){
		...
		loadDiv.html('<img src="http://s2.ygimg.cn/template/commonimages/loading.gif"> 处理中，请稍候...');
		//loadDiv.html('<img src="images/loading16.gif" />');
...
+'<div class="uiDiv">'
+'<table class="uiTable"><tbody><tr><td><div class="clearfix dg_title"><h3 class="uiTitle">&nbsp;</h3><a class="uiClose" href="javascript:;">&nbsp;</a></div></td></tr><tr><td><div class="dg_content"><p class="dg_loading"><image src="http://s2.ygimg.cnimages/loading16.gif" /></p></div></td></tr></tbody></table></div></div>';
